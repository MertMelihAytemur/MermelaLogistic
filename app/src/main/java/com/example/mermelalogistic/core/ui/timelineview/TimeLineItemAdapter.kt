...
import com.example.mermelalogistic.databinding.ItemTimelineBinding
import com.example.mermelalogistic.databinding.ItemTimelineVerticalBinding

/**
 *Created by Mert Melih Aytemur on 6/15/2023.
 */
class TimeLineItemAdapter(
    var timelineOrientation : TimelineOrientation = TimelineOrientation.HORIZONTAL
    ...
    override fun getItemViewType(position: Int): Int {
        return when (timelineOrientation) {
            TimelineOrientation.HORIZONTAL -> HORIZONTAL_VIEW_TYPE_ID
            TimelineOrientation.VERTICAL -> VERTICAL_VIEW_TYPE_ID
        }
    }
